...
export var ApplyEnvironmentManagedActionRequest = [3, n0, _AEMAR, 0, [_EN, _EI, _AI], [0, 0, 0]];
...
TypeRegistry.for(_s).registerError(ElasticBeanstalkSyntheticServiceException, __ElasticBeanstalkSyntheticServiceException);
export var ApplicationDescriptionList = [1, n0, _ADL, 0, () => ApplicationDescription];
export var ApplicationNamesList = 64 | 0;
export var ApplicationVersionDescriptionList = [1, n0, _AVDL, 0, () => ApplicationVersionDescription];
export var AutoScalingGroupList = [1, n0, _ASGL, 0, () => AutoScalingGroup];
export var AvailableSolutionStackDetailsList = [1, n0, _ASSDL, 0, () => SolutionStackDescription];
export var AvailableSolutionStackNamesList = 64 | 0;
export var Causes = 64 | 0;
export var ConfigurationOptionDescriptionsList = [
    1,
    n0,
    _CODL,
    0,
...
export var ConfigurationOptionSettingsList = [1, n0, _COSL, 0, () => ConfigurationOptionSetting];
export var ConfigurationSettingsDescriptionList = [
    1,
    n0,
    _CSDL,
    0,
...
export var CustomAmiList = [1, n0, _CAL, 0, () => CustomAmi];
export var EnvironmentDescriptionsList = [1, n0, _EDL, 0, () => EnvironmentDescription];
export var EnvironmentHealthAttributes = 64 | 0;
export var EnvironmentIdList = 64 | 0;
export var EnvironmentInfoDescriptionList = [1, n0, _EIDL, 0, () => EnvironmentInfoDescription];
export var EnvironmentLinks = [1, n0, _EL, 0, () => EnvironmentLink];
export var EnvironmentNamesList = 64 | 0;
export var EventDescriptionList = [1, n0, _EDLv, 0, () => EventDescription];
export var InstanceHealthList = [1, n0, _IHL, 0, () => SingleInstanceHealth];
export var InstanceList = [1, n0, _IL, 0, () => Instance];
export var InstancesHealthAttributes = 64 | 0;
export var LaunchConfigurationList = [1, n0, _LCL, 0, () => LaunchConfiguration];
export var LaunchTemplateList = [1, n0, _LTL, 0, () => LaunchTemplate];
export var LoadAverage = 64 | 1;
export var LoadBalancerList = [1, n0, _LBL, 0, () => LoadBalancer];
export var LoadBalancerListenersDescription = [1, n0, _LBLD, 0, () => Listener];
export var ManagedActionHistoryItems = [1, n0, _MAHI, 0, () => ManagedActionHistoryItem];
export var ManagedActions = [1, n0, _MA, 0, () => ManagedAction];
export var OptionsSpecifierList = [1, n0, _OSL, 0, () => OptionSpecification];
export var PlatformBranchSummaryList = [1, n0, _PBSL, 0, () => PlatformBranchSummary];
export var PlatformFilters = [1, n0, _PFla, 0, () => PlatformFilter];
export var PlatformFilterValueList = 64 | 0;
export var PlatformFrameworks = [1, n0, _PFlat, 0, () => PlatformFramework];
export var PlatformProgrammingLanguages = [1, n0, _PPLl, 0, () => PlatformProgrammingLanguage];
export var PlatformSummaryList = [1, n0, _PSL, 0, () => PlatformSummary];
export var QueueList = [1, n0, _QL, 0, () => Queue];
export var SearchFilters = [1, n0, _SFe, 0, () => SearchFilter];
